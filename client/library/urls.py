...
from . import views, api_views, client_upload_views
...
urlpatterns = [
    ...
    path('documents/', views.document_list_horizontal, name='document_list'),
    path('documents/horizontal/', views.document_list_horizontal, name='document_list_horizontal'),
    path('category/<path:category>/', views.documents_by_category, name='documents_by_category'),
