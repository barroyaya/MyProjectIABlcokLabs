...
urlpatterns = [
    ...
    # ——— CRUD Annotations (API canonique) ————————————————————
    ...
    # alias court, nom unique
    path("annotate/<int:doc_id>/", views.expert_annotate_document, name="annotate_document_short"),

    # ——— IA (Groq) ————————————————————————————————————————————
    # endpoint canonique
    path("api/groq/<int:page_id>/", views.expert_ai_annotate_page_groq, name="ai_annotate_page_groq"),
    # alias legacy (nom différent)
    path("annotation/groq/<int:page_id>/", views.expert_ai_annotate_page_groq, name="ai_annotate_page_groq_legacy"),

    # ——— Création manuelle ——————————————————————————————————
    path("api/save-annotation/", views.expert_save_manual_annotation, name="save_manual_annotation"),
    path("annotation/manual/", views.expert_save_manual_annotation, name="save_manual_annotation_legacy"),

    # ——— Récupération des annotations d’une page ——————————————
    # canonique
    path("api/get-annotations/<int:page_id>/", views.expert_get_page_annotations, name="get_page_annotations"),
    # alias pour anciens JS, nom unique
    path("annotation/page/<int:page_id>/", views.expert_get_page_annotations, name="get_page_annotations_legacy"),

    # ——— Suppression / validation en masse ——————————————————
    path("annotation/<int:annotation_id>/delete/", views.expert_delete_annotation, name="delete_annotation_expert"),
    path("api/delete-annotation/<int:annotation_id>/", views.expert_delete_annotation, name="delete_annotation_api"),
    path("annotation/validate-page/<int:page_id>/", views.expert_validate_page_annotations, name="validate_page_annotations"),

    # ——— Page: JSON & Résumés ————————————————————————————————
    path("annotation/page/<int:page_id>/generate-summary/",
         views.expert_generate_page_annotation_summary,
         name="generate_page_annotation_summary"),
    path("annotation/page/<int:page_id>/view-json/",
         views.expert_view_page_annotation_json,
    ...
    path("annotation/page/<int:page_id>/update-from-annotations/",
         views.update_summary_from_annotations,
         name="update_summary_from_annotations"),

    # ——— Document: JSON & Résumés ——————————————————————————————
    path("annotation/document/<int:doc_id>/generate-summary/",
         views.expert_generate_document_annotation_summary,
         name="generate_document_annotation_summary"),
    path("annotation/document/<int:doc_id>/view-json/",
         views.expert_view_document_annotation_json,
         name="view_document_annotation_json"),
    path("annotation/document/<int:doc_id>/view-json-enriched/",
    ...
    path("document/<int:doc_id>/auto-regenerate-summary/",
         views.auto_regenerate_summary_from_annotations,
         name="auto_regenerate_summary_from_annotations"),

    # ——— Enrichissement (relations, QA…) ————————————————————
    path("annotation/document/<int:doc_id>/enrich-json/", views_enrichment.enrich_document_json, name="enrich_document_json"),
    ...
    path("annotation/document/<int:doc_id>/save-enriched-edits/", views_enrichment.save_enriched_edits, name="save_enriched_json_manual_edits"),
    path("annotation/document/<int:doc_id>/qa-feedback/", views_enrichment.qa_feedback, name="qa_feedback"),
    path("annotation/document/<int:doc_id>/from-paragraph/", views_enrichment.paragraph_to_relations, name="paragraph_to_relations"),

    # ——— Learning (comparaison, stats) ——————————————————————
    path("document/<int:doc_id>/compare-and-learn/", views_learning.compare_with_ai_and_learn, name="compare_with_ai_and_learn"),
    path("document/<int:doc_id>/learning-history/", views_learning.get_learning_history, name="get_learning_history"),
    path("document/<int:doc_id>/enhance-with-patterns/", views_learning.enhance_with_learned_patterns, name="enhance_with_learned_patterns"),
    path("document/<int:doc_id>/view-expert-deltas/", views_learning.view_expert_deltas, name="view_expert_deltas"),
    path("document/<int:doc_id>/regenerate-with-learning/", views_learning.regenerate_with_learning, name="regenerate_with_learning"),
...
#########
# Dans la section enrichment
    path('annotation/document/<int:doc_id>/describe-relation/',
         views_enrichment.describe_relation,
         name='describe_single_relation'),

    path('annotation/document/<int:doc_id>/add-relations-batch/',
     views_enrichment.add_relations_batch,
     name='add_relations_batch'),

    path('annotation/document/<int:doc_id>/describe-relations-batch/',
     views_enrichment.describe_relations_batch,
     name='describe_relations_batch'),

    #########
# expert/urls.py - Ajouter dans la section enrichment
    path('annotation/document/<int:doc_id>/analyze-paragraph/',
         views_enrichment.analyze_paragraph,
         name='analyze_paragraph'),

    path('annotation/document/<int:doc_id>/save-paragraph-relations/',
         views_enrichment.save_paragraph_relations,
